...
import { generateMcpKeyAction, type McpKeyRow, revokeMcpKeyAction } from "@/actions/mcp";
...
export function McpKeysPanel({ workspaceId, workspaceName, serverUrl, initialKeys }: Props) {
